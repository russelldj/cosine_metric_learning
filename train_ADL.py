...
class Market1501(object):
    ...
    def read_train(self):
        filenames, ids, camera_indices = ADL.read_train_split_to_str(
            self._dataset_dir)
    ...
    def read_test(self):
        return ADL.read_test_split_to_str(self._dataset_dir)


def main():
    arg_parser = train_app.create_default_argument_parser("ADL")
    ...
    if args.mode == "train":
        ...
        network_factory = net.create_network_factory(
            is_training=True, num_classes=ADL.MAX_LABEL + 1,
        ...
        train_app.train_loop(
            ...
            num_images_per_id=4, image_shape=ADL.IMAGE_SHAPE,
            **train_kwargs)
    elif args.mode == "eval":
        ...
        train_app.eval_loop(
            ...
            image_shape=ADL.IMAGE_SHAPE, **eval_kwargs)
        ...
        gallery_features = train_app.encode(
            ...
            gallery_filenames, image_shape=ADL.IMAGE_SHAPE)
        sio.savemat(
        ...
        query_features = train_app.encode(
            net.preprocess, network_factory, args.restore_path,
            query_filenames, image_shape=ADL.IMAGE_SHAPE)
        sio.savemat(
        ...
        train_app.finalize(
            ...
            image_shape=ADL.IMAGE_SHAPE,
            output_filename="./ADL.ckpt")
